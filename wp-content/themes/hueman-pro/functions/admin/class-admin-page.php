      ...
      <div class="hueman-admin-panel">
        <div class="about-text tc-welcome">
          ...
          <?php
            if ( !HU_IS_PRO ) {
              printf( '<h3>%1$s 🙏</h3>',
                sprintf( __( "If you enjoy using the Hueman theme for your website, please consider %s. Your support allows us to keep the theme at the highest level. Thank you!", "hueman-pro"),
                  sprintf( '<a href="%1$s" title="%2$s" target="_blank">%2$s</a>', 'https://presscustomizr.com/hueman-pro/', __("upgrading to the pro version", "hueman-pro") )
                )
              );
            }
          ?>
