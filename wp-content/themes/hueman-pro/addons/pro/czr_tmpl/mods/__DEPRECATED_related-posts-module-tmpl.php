...
function hu_print_related_posts_mod_js_templates() {
  ...
  <div class="tabs tabs-style-topline">
      <nav>
        <ul>
          <li data-tab-id="section-topline-1"><a href="#"><span><?php _e( 'Design', 'hueman-pro' ); ?></span></a></li>
          <li data-tab-id="section-topline-2"><a href="#"><span><?php _e( 'Related posts', 'hueman-pro' ); ?></span></a></li>
        </ul>
      </nav>
      ...
      <div class="content-wrap">
        ...
        <section id="section-topline-1">
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              #>
              <div class="customize-control-title"><?php _e('Display related posts after a single post', 'hueman-pro'); ?></div>
              <div class="czr-input">
                <input data-czrtype="enable" type="checkbox" {{ _checked }}></input>
              </div>
              <span class="czr-notice"><?php _e('This is a good way to engage your visitors and generate more page views.', 'hueman-pro'); ?></span>
            </div>

            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="number">
              <div class="customize-control-title"><?php _e('Max number of columns', 'hueman-pro'); ?></div>
              <div class="czr-input">
                <input data-czrtype="col_number" type="number" step="1" min="1" max="4" value="{{ data['col_number'] }}" />
              </div>
              <span class="czr-notice"><?php _e("1 to 4 columns. The number of post columns will be adapted depending on the choosen page layout and the user's device.", 'hueman-pro'); ?></span>
            </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
              ...
              #>
              <div class="customize-control-title"><?php _e('Display a heading for the related posts', 'hueman-pro'); ?></div>
              <div class="czr-input">
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text">
              <div class="customize-control-title"><?php _e("Heading's text", 'hueman-pro'); ?></div>
              <div class="czr-input">
                <input data-czrtype="heading_text" type="text" value="{{ data['fixed-title'] }}" placeholder="<?php _e('Enter a heading', 'hueman-pro'); ?>"/>
              </div>
            </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
                ...
                <span class="czr-notice"><?php _e('Enables your posts to be freely scrolled and flicked without being aligned to an end position.', 'hueman-pro'); ?></span>
            </div>
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
                ...
                #>
                <div class="customize-control-title"><?php _e('Load just in time', 'hueman-pro'); ?></div>
                <div class="czr-input">
        ...
        <section id="section-topline-2">
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="number">
              <div class="customize-control-title"><?php _e('Maximum number of related posts', 'hueman-pro'); ?></div>
              <div class="czr-input">
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="select">
              <div class="customize-control-title"><?php _e('Relationship', 'hueman-pro'); ?></div>
              <div class="czr-input">
            ...
            <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="select">
              <div class="customize-control-title"><?php _e('Choose how to sort your related posts', 'hueman-pro'); ?></div>
              <div class="czr-input">
                <select data-czrtype="order_by"></select>
              </div>
              <span class="czr-notice"><?php _e('The descending order is always used when relevant.', 'hueman-pro'); ?></span>
            </div>
        </section>
      </div><!-- /content -->
    </div><!-- /tabs -->
